...
const config = {
  "generator": {
    ...
    "output": {
      "value": "E:\\gsapi-test\\api-docs\\src\\datasources\\prisma-clients\\test",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "sourceFilePath": "E:\\gsapi-test\\api-docs\\src\\datasources\\test.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "datasource db {\n  provider = \"sqlite\" // name of database provider\n  url      = \"file:./dev.db\" // DB_URL string will be added in .env file\n}\n\ngenerator client {\n  provider        = \"prisma-client-js\"\n  output          = \"./prisma-clients/test\"\n  previewFeatures = [\"metrics\"]\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n  posts Post[]\n}\n\nmodel Post {\n  id        Int     @id @default(autoincrement())\n  title     String\n  content   String?\n  published Boolean @default(false)\n  author    User    @relation(fields: [authorId], references: [id])\n  authorId  Int\n}\n",
  "inlineSchemaHash": "56cffcce7376cdbc73e8d797b0f8292f30cbd48ba4ba7248a651695d579f8323",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/datasources/prisma-clients/test",
    "datasources/prisma-clients/test",
  ]
...
path.join(process.cwd(), "src/datasources/prisma-clients/test/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/datasources/prisma-clients/test/schema.prisma")
